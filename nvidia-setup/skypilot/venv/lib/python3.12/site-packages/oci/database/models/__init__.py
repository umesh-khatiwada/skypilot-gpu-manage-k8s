...
from .create_db_home_with_vm_cluster_id_from_database_details import CreateDbHomeWithVmClusterIdFromDatabaseDetails
...
database_type_mapping = {
    ...
    "CreateDbHomeWithVmClusterIdFromDatabaseDetails": CreateDbHomeWithVmClusterIdFromDatabaseDetails,
