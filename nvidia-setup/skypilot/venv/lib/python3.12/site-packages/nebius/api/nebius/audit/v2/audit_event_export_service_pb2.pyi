...
from nebius.api.nebius.audit.v2 import audit_event_export_pb2 as _audit_event_export_pb2
...
class ListAuditEventExportResponse(_message.Message):
    ...
    items: _containers.RepeatedCompositeFieldContainer[_audit_event_export_pb2.AuditEventExport]
    next_page_token: str
    def __init__(self, items: _Optional[_Iterable[_Union[_audit_event_export_pb2.AuditEventExport, _Mapping]]] = ..., next_page_token: _Optional[str] = ...) -> None: ...
