...
from nebius.api.nebius.iam.v1 import group_membership_pb2 as _group_membership_pb2
...
class CreateGroupMembershipRequest(_message.Message):
    ...
    spec: _group_membership_pb2.GroupMembershipSpec
    revoke_after_hours: int
