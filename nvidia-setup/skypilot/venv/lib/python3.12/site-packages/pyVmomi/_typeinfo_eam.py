...
CreateEnumType("eam.lccm.Hooks.HookType", "HooksHookType", "eam.version.version1", ["POST_PROVISIONING", "PRE_POWER_ON", "POST_POWER_ON"])
CreateEnumType("eam.lccm.Hooks.ExternalProcessingResult", "HooksExternalProcessingResult", "eam.version.version1", ["SUCCESS", "UNKNOWN_ERROR", "VM_CONFIG_ERROR"])
CreateDataType("eam.lccm.Hooks.HookProcessSpec", "HooksHookProcessSpec", "vmodl.DynamicData", "eam.version.version1", [("vm", "vim.VirtualMachine", "eam.version.version1", 0), ("hookType", "string", "eam.version.version1", 0), ("processingResult", "string", "eam.version.version1", 0)])
...
CreateDataType("eam.lccm.Solutions.TransitionInfo", "SolutionsTransitionInfo", "vmodl.DynamicData", "eam.version.version1", [("solution", "string", "eam.version.version1", 0), ("agencyId", "string", "eam.version.version1", 0)])
CreateDataType("eam.lccm.Solutions.ApplySpec", "SolutionsApplySpec", "vmodl.DynamicData", "eam.version.version1", [("desiredState", "eam.lccm.Solutions.SolutionConfig[]", "eam.version.version1", F_OPTIONAL), ("transitionMap", "eam.lccm.Solutions.TransitionInfo[]", "eam.version.version1", F_OPTIONAL), ("solutions", "string[]", "eam.version.version1", F_OPTIONAL), ("hosts", "vim.HostSystem[]", "eam.version.version1", F_OPTIONAL)])
CreateDataType("eam.lccm.Solutions.ValidateSpec", "SolutionsValidateSpec", "vmodl.DynamicData", "eam.version.version1", [("desiredState", "eam.lccm.Solutions.SolutionConfig[]", "eam.version.version1", 0), ("transitionMap", "eam.lccm.Solutions.TransitionInfo[]", "eam.version.version1", F_OPTIONAL)])
...
CreateDataType("eam.lccm.Solutions.SolutionApplicationResult", "SolutionsSolutionApplicationResult", "vmodl.DynamicData", "eam.version.version1", [("solution", "string", "eam.version.version1", 0), ("installing", "boolean", "eam.version.version1", 0), ("validation", "eam.lccm.Solutions.SolutionValidationResult", "eam.version.version1", 0)])
CreateDataType("eam.lccm.Solutions.HostApplicationResult", "SolutionsHostApplicationResult", "vmodl.DynamicData", "eam.version.version1", [("host", "vim.HostSystem", "eam.version.version1", 0), ("started", "boolean", "eam.version.version1", 0), ("hostOperational", "boolean", "eam.version.version1", 0), ("solutions", "eam.lccm.Solutions.SolutionApplicationResult[]", "eam.version.version1", F_OPTIONAL)])
...
CreateDataType("eam.lccm.Solutions.SolutionComplianceResult", "SolutionsSolutionComplianceResult", "vmodl.DynamicData", "eam.version.version1", [("solution", "string", "eam.version.version1", 0), ("compliant", "boolean", "eam.version.version1", 0), ("installing", "boolean", "eam.version.version1", 0), ("nonComplianceReason", "string", "eam.version.version1", F_OPTIONAL), ("vm", "vim.VirtualMachine", "eam.version.version1", F_OPTIONAL), ("upgradingVm", "vim.VirtualMachine", "eam.version.version1", F_OPTIONAL), ("hook", "eam.lccm.Hooks.HookInfo", "eam.version.version1", F_OPTIONAL), ("issues", "eam.issue.Issue[]", "eam.version.version1", F_OPTIONAL), ("solutionConfig", "eam.lccm.Solutions.SolutionConfig", "eam.version.version1", F_OPTIONAL)])
...
CreateDataType("eam.lccm.Solutions.ApplicationResult", "SolutionsApplicationResult", "vmodl.DynamicData", "eam.version.version1", [("hosts", "eam.lccm.Solutions.HostApplicationResult[]", "eam.version.version1", F_OPTIONAL)])
